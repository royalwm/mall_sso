...
<body>
	<!-- header -->
	<div class="header">
		<a href="http://127.0.0.1:8081/mall"><img src="/images/百货之家.png" border="0"><span>欢迎登录</span></a>
	</div>
	<!-- login_main -->
	<div class="login_main clear">
		<div class="pic">
			<a href="https://image.baidu.com/search/detail?z=0&ipn=false&word=%E6%9E%97%E5%85%81%E5%84%BF%E5%A3%81%E7%BA%B8&step_word=&hs=0&pn=3&spn=0&di=198637055210&pi=&tn=baiduimagedetail&is=0%2C0&istype=0&ie=utf-8&oe=utf-8&cs=1717651055%2C2181173320&os=3903114291%2C1748852769&simid=&adpicid=0&lpn=0&fm=&sme=&cg=star&bdtype=0&simics=2522219038%2C2516402949&oriquery=&objurl=https%3A%2F%2Ftimgsa.baidu.com%2Ftimg%3Fimage%26quality%3D80%26size%3Db10000_10000%26sec%3D1521535758%26di%3D70e1b0a6c9ec1b9c0d2186456d103eb5%26src%3Dhttp%3A%2F%2F4493bz.1985t.com%2Fuploads%2Fallimg%2F151228%2F1-15122Q62552.jpg&fromurl=ippr_z2C%24qAzdH3FAzdH3Fktzit_z%26e3B99ln_z%26e3Bv54AzdH3Ft4w2jAzdH3F8cl0d_z%26e3Bip4s&gsm=0&cardserver=1" target="_blank"><img width="500" height="300" src="/images/林允儿.jpg"></a>
		</div>
		<!-- login -->
		<div class="login">
			...
			<div class="login_box clear">
				...
				<ul class="blink">
					<li class="p-f10">
						...
						<div>
							<a href="https://user.qzone.qq.com/1245857108/infocenter" class="link">QQ</a>&nbsp;|&nbsp; 
							<a href="https://user.qzone.qq.com/1245857108/infocenter" class="link">新浪微博</a> &nbsp;|&nbsp; 
							<a href="https://user.qzone.qq.com/1245857108/infocenter" class="link">腾讯微博</a> &nbsp;|&nbsp;
							 <a href="https://user.qzone.qq.com/1245857108/infocenter" class="link">支付宝</a>
						</div>
					</li>
				</ul>
			</div>
	...
	<!-- /login_main -->
	<div class="footer">
		<span> <a href="http://www.baidu.com" rel="nofollow" class="footerlink1">关于我们</a> | <a href="http://www.baidu.com" rel="nofollow" class="footerlink1">联系我们</a> | <a href="http://www.baidu.com" rel="nofollow" class="footerlink1">招聘人才</a> | <a href="http://www.baidu.com" rel="nofollow" class="footerlink1">友情链接</a> | <a href="http://www.baidu.com" rel="nofollow" class="footerlink1">供应商申请</a>
		</span>
		<p>
			百货之家<br> 南京工程学院备案202141737号|<a href="http://www.njit.edu.cn/" target="_blank" rel="nofollow" class="footerlink1">京ICP备12011349号</a>|<a href="http://www.e3mall.cn/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br> Copyright© 百货之家版权所有<br>
		</p>
	</div>
	<!-- /footer -->
				...
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data =="1") {
						jAlert('登录成功！',"提示", function(){
							if (redirectUrl == "") {
								location.href = "http://127.0.0.1:8081/mall";
							} else {
