...
<body>
		<!-- header -->
		<div class="header">
			<a href="http://127.0.0.1:8081/mall"><img src="/images/百货之家.png" border="0" /><span>欢迎注册</span></a>
		</div>
...
<div class="tabBox clear">
    ...
    <div class="login">已有账号，立即 <a href="/login">登录</a></div>
</div>
<!--个人用户-->
<div class="reg_main reg_border regTab" id="perDiv">
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post"  >
			...
			<span  class="regM" style="margin-left:29px">
				...
				<a href="/register/readProtocol" target="_blank"  class="checkTitle">我已阅读并同意<font style="font-size:12px;">《百货之家用户注册协议》</font></a>
			</span>
    ...
    <div class="ui-reg-tip"><a href="http://www.baidu.com" target="_blank">了解更多>></a></div>
</div>
